...
export default function EmailLogin() {
  ...
  const goToWelcomeLogin = () => {
    navigate(`/`);
  };
  const goToEmailRegister = () => {
    navigate(`/register-email?role=${role}`);
  };
    ...
    <div style={styles.container}>
      ...
      <div style={styles.card} className="animate-fade-slide">
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.backButton} onClick={goToEmailRegister}>
            Create an account
          </div>
          <div style={styles.backButton} onClick={goToWelcomeLogin}>
